...
public class mxSaxOutputHandler extends DefaultHandler
{
	...
	protected void initHandlers()
	{
		...
		handlers.put("arc", new IElementHandler()
		{
			public void parseElement(Attributes atts)
			{
				canvas.arcTo(Double.parseDouble(atts.getValue("rx")),
						Double.parseDouble(atts.getValue("ry")),
						Double.parseDouble(atts.getValue("theta")),
						atts.getValue("arc").equals("1"),
						atts.getValue("sweep").equals("1"),
						Double.parseDouble(atts.getValue("x")),
						Double.parseDouble(atts.getValue("y")));
			}
		});
