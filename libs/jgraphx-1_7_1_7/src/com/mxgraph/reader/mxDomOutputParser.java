...
public class mxDomOutputParser
{
	...
	protected void initHandlers()
	{
		...
		handlers.put("arc", new IElementHandler()
		{
			public void parseElement(Element elt)
			{
				canvas.arcTo(Double.parseDouble(elt.getAttribute("rx")),
						Double.parseDouble(elt.getAttribute("ry")),
						Double.parseDouble(elt.getAttribute("theta")),
						elt.getAttribute("arc").equals("1"),
						elt.getAttribute("sweep").equals("1"),
						Double.parseDouble(elt.getAttribute("x")),
						Double.parseDouble(elt.getAttribute("y")));
			}
		});
